...
type ActionTypes = AddPostActionCreatorActionType | SetUserProfileActionType | SetUserStatusActionType | DeletePostActionType |
...
export const saveProfile = (profileData: any): ThunkType => async (dispatch: any, getState: any) => {
